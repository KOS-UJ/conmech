...
class LiveDataset(ScenariosDataset):
    def __init__(
        ...
        super().__init__(
            description=f"{description}_live", all_scenarios=all_scenarios,
    ...
    def update_data(self):
        ...
        for i, scenario in enumerate(self.all_scenarios):
            scenario.schedule.final_time = min(scenario.schedule.final_time + 0.1,
                                               self.initial_final_times[i])
        print(
