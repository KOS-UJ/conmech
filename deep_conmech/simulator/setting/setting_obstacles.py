...
@njit
def get_normal_tangential_numba(vector, normal):
...
def obstacle_resistance_potential_tangential(
    penetration, tangential_velocity
):
...
def integrate_numba(
    ...
    for i in range(len(nodes)):
        ...
        v_tangential = get_tangential(v[i], nodes_normals[i])
