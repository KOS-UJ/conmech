...
from conmech.helpers.spatial_hashing import Hasher
...
# r = Hasher(nodes=nodes, spacing=0.1).query(nodes[0], max_dist = 0.05)
...
with timer["iterate_test_loop2"]:
    result_loop = iterate_test_loop2(values)
...
for v, k in iterate_test_loop.inspect_llvm().items():
    print(v, k)
# iterate_test_broadcast.inspect_types()
# iterate_test_loop.inspect_types()
# x = 0
