...
if __name__ == "__main__":
    ...
    optimal = (ue[ks[0], 0] * np.asarray(h_ticks) ** 0.5)
    ...
    plt.plot(h_ticks, (te[ks[0], 0] * np.asarray(h_ticks) ** 0.5), color="silver", linewidth=4.0, label="optimal")
    for k in ks:
