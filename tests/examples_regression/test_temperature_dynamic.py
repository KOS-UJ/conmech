...
def generate_test_suits():
    ...
    expected_temperature_vector_m02_m02 = np.asarray(
        [0., 0.00741997, 0.01221737, 0.01461224, 0.01550476,
         0.01570057, 0.01349775, 0.01272145, 0.01252292, 0.01156353,
         0.00904915, 0.00461392, 0., 0.])
    ...
    expected_temperature_vector_0_02_p_0 = np.asarray(
        [0., 0.01173292, 0.02592385, 0.0366083, 0.04319379,
         0.04541048, 0.03947971, 0.03799222, 0.03641584, 0.03174365,
         0.02423631, 0.01431277, 0., 0.])
    ...
    expected_temperature_vector_var = np.asarray(
        [0., 0.01123686, 0.01831312, 0.02273589, 0.02529368,
         0.02612974, 0.01730311, 0.01389807, 0.01261098, 0.00907683,
         0.00425763, -0.00028913, 0., 0.])
